...
private:
    ...
    void updatePropertiesDockVisibility();
    QToolBar *createGroupedToolBar(const QString &objectName, const QList<QAction *> &actions, const QString &title);
